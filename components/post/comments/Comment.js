...
export default function Comment({comment, setUserProfile}) {
    return(
        <li key={comment.id} className=" flex-col font-extralight text-gray-500 break-all">
            <div className="flex cursor-pointer align-center " onClick={() => getProfile(comment.username, setUserProfile)}>
            ...
            <div>
              <p className=" text-white text-xs sm:text-base lg:text-2xl break-words flex align-center">
                {comment.text}
              </p>
