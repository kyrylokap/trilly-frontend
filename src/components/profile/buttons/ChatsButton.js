...
export default function ChatsButton({changeAside, openSettings}){
    return(
        <div className={`flex justify-center items-center gap-1 cursor-pointer h-10 group`} onClick={() => {
            changeAside(false);
            openSettings(false);
        }}>
            ...
            <p className="text-black duration-200 group-hover:text-[gray] text-transparent hidden md:block">Chats</p>
